...
1. Install [Fabric Loader](https://fabricmc.net/use/) 0.16.14 or newer for Minecraft 1.21.1.
2. Download [Fabric API](https://modrinth.com/mod/fabric-api) 0.116.15+1.21.1 or newer and drop the jar
   into `.minecraft/mods/`.
