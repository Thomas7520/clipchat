...
1. Install [Fabric Loader](https://fabricmc.net/use/) 0.19.3 or newer for Minecraft 1.20.6.
2. Download [Fabric API](https://modrinth.com/mod/fabric-api) 0.100.8+1.20.6 or newer and drop the jar
   into `.minecraft/mods/`.
