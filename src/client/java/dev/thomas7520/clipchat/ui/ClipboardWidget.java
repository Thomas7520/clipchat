...
public final class ClipboardWidget {
	...
	private static final ResourceLocation PIN_ICON = new ResourceLocation("clipchat", "textures/gui/pin.png");
	private static final ResourceLocation SETTINGS_ICON =
			new ResourceLocation("clipchat", "textures/gui/settings.png");
