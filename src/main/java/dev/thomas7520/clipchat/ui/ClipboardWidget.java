...
public final class ClipboardWidget {
	...
	public void extract(GuiGraphics graphics, Font font, int screenWidth, int screenHeight,
	 ...
	 */
	public boolean keyPressed(int keyCode, int screenHeight) {
		if (hidden() || geometry.collapsed() || !Screen.hasControlDown()) {
			return false;
		}
